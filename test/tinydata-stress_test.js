...
"4203053407": function(exports, module, require) {
// /Users/meettya/github/TinyData/test/tinydata-stress_test.coffee 
/*
...
describe('TinyData: stress test', function() {
  ...
  reference_func = function(in_obj) {
    var element, item, item_idx, like_dict, name, value, _i, _j, _len, _len1, _ref;
      ...
      for (name in item) {
        ...
        if (name === 'like') {
          for (_j = 0, _len1 = value.length; _j < _len1; _j++) {
            element = value[_j];
            if ((_ref = like_dict[element]) == null) {
              like_dict[element] = [];
            }
